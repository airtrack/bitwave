...
struct OutPutFileInfo : public std::unary_function<bittorrent::MetainfoFile::FileInfo, void>
{
    OutPutFileInfo(std::ostream& os) : os_(os) { }

    void operator () (const bittorrent::MetainfoFile::FileInfo& info) const
    {
...
int main()
{
    try
    {
        ...
        bittorrent::MetainfoFile torrentfile(filename.c_str());
        ...
        std::vector<bittorrent::MetainfoFile::FileInfo> files;
